...
| E008 | CURRENT_COMMAND | powershell.exe -NoProfile -ExecutionPolicy Bypass -File scripts/container-pytest.ps1 -Image museecho-task3-verification-env:latest; .venv\Scripts\python.exe -m pytest tests/unit/test_task20_final_delivery_contract.py -q | tests | AC-A-1, AC-A-2, AC-A-3, AC-A-4, AC-D-1, AC-D-2, AC-D-3, AC-D-4, AC-E-1, AC-E-2, AC-E-3, AC-F-1, DOD-01, DOD-02, DOD-04, DOD-05, DOD-06, DOD-07, DOD-14, DOD-15 | container-pytest=841; container-skipped=7; powershell-host-pytest=20 | - | 2026-08-14T09:00:00Z | 0 | - | Current branch source mounted read-only into the retained FFmpeg-capable Linux verification image passed 841 tests and skipped seven host/tool-specific tests, including the 100 MiB upload-limit regressions. The current PowerShell host separately passed all 20 delivery-contract tests, including the four PowerShell harnesses skipped in Linux. Together these runs cover the retained current-source suite; this is test evidence, not a current production-image build. |
