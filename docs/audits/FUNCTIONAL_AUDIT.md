...
- **Generated at UTC:** `2026-08-14T09:03:00Z`
...
`PARTIALLY_READY` is mandatory: final-branch GitHub CI, target-server/public deployment,
...
| E901 | EXTERNAL_NOT_RUN | NOT RUN: final branch GitHub CI requires the pushed final commit and live PR checks | .github/workflows/ci.yml | DOD-10 | final-github-ci=NOT_RUN | - | 2026-08-12T19:11:39Z | NOT_RUN | - | GitHub implementation-boundary jobs are green as E906, but they do not establish the final branch-tip result; GitLab is retained only as optional follow-up configuration. |
...
| DOD-10 | PARTIAL | IMPORTANT | E901, E906 | Repository owner | BLOCKER:REMOTE-CI | The product/CI implementation boundary is green; the external PR merge gate must require quality, E2E, and distribution success for the final branch-tip SHA. |
...
| REMOTE-CI | EXTERNAL | OPEN | Repository owner | E901 | Require the GitHub PR merge gate to pass quality, E2E, and distribution for the final branch-tip SHA; GitLab remains optional follow-up configuration and is not a current course gate. |
