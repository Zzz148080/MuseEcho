...
- **Generated at UTC:** `2026-08-11T17:39:47Z`
...
| E014 | CURRENT_COMMAND | uv run pytest tests/unit/test_acceptance_matrix.py -q && uv run python scripts/check_acceptance_matrix.py SPEC.md docs/audits/FUNCTIONAL_AUDIT.md | tests/unit/test_acceptance_matrix.py | AC-F-1, DOD-15 | pytest-tests=37; pass=28; partial=12; fail=0 | - | 2026-08-11T17:39:47Z | 0 | - | Review gate rejects stale current claims; the exact wrapper remains unavailable on this host and the equivalent locked-Python gate is recorded in the Task 23 report. |
